...
function SearchBarWithSelectBox({ placeholder = "En cours" }) {
  return (
    <div className={"form-control w-[28em]"}>
      <div className='flex items-centers  rounded-md bg-gray-50 border-custom-l3 focus-within:ring-custom-l2 focus-within:ring-2 border-2'>
        <select className='ml-2 outline-none  bg-transparent' name='' id=''>
          <option>{placeholder}</option>
          <option>Option 1</option>
          <option>Option 2</option>
        </select>
        <div className='!h-[2em] w-1 my-auto mx-2 bg-gray-300 z-10'></div>
