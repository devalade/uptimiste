  ...
  return (
    <main className="bg-custom-light h-screen overflow-y-hidden text-gray-700 font-main  relative">
      <div className="flex items-start justify-between">
        <SideBar />
        <div className="mx-8 w-full h-full min-h-screen overflow-y-auto scrollbar-hide">
              ...
              <div className="w-full h-full px-8 pt-6 border border-gray-200">
                ...
                <div class="overflow-x-auto">
                  <table class="table w-full">
                    <thead className="!bg-custom-l1 z-50">
                      <tr className="!bg-custom-l1">
                        <th>Nom de le pièce</th>
                        <th>Date d’ajout</th>
                        <th>Actions</th>
                      </tr>
                    </thead>
